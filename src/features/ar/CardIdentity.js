    ...
    renderInitialScene = () => {
        return (
            <ViroARScene >
                ...
                <Card targetName="hoangLe" image={Images.photos.avaHoang} name="Mr. Le Huy Hoang" team="Hades" />
                <Card targetName="manhVu" image={Images.photos.avaManh} name="Mr. Vu Tien Manh" team="Hades" />
            </ViroARScene>
        )
    }
